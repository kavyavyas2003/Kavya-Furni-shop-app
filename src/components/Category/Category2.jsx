...
import Image1 from "../../assets/category/bookshelfpng.jpg";
import Image2 from "../../assets/category/ottomen.jpeg";
import Image3 from "../../assets/category/chair.png";
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="sm:col-span-2 py-10 pl-5 bg-gradient-to-br from-gray-400/90 to-gray-100 text-white rounded-3xl relative h-[320px] flex items-end">
            ...
            <img
              src={Image1}
              alt=""
              className="w-[500px] absolute top-1/2 -translate-y-1/2 -right-0 opacity-10"
            />
          </div>
          {/* Second col */}
