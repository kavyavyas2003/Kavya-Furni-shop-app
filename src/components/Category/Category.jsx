...
import Image1 from "../../assets/category/tablee.jpeg";
import Image2 from "../../assets/category/chairpng.jpeg"; // Assuming the file name is correct
import Image3 from "../../assets/category/bedpng.png";
...
<div className="py-10 pl-5 bg-gradient-to-br from-brandYellow to-brandYellow/90 text-white rounded-3xl relative h-[320px] flex items-end">
  <div className="z-10 relative"> {/* Adjusted z-index here */}
    <div className="mb-4">
      <p className="mb-[2px] text-black">Enjoy</p>
      <p className="text-2xl font-semibold mb-[2px]">With</p>
      <p className="text-4xl xl:text-5xl font-bold opacity-100 mb-2 text-red-400">
        Chair
      </p>
      <Button
        text="Browse"
